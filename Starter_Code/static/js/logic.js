...
// });
  ...
  // Question for tutor, I calculated the coordinates and radius, how do I get those back into the magnitudeMarkers variable?
  function getRadius(magnitude) {
    ...
    //   let magnitude = feature.features.properties.mag;
    //   // Get the coordinates
    //   let coordinates = feature.features.geometry.coordinates;
    //   // Assign radius based on magnitude. 
    //   let radius = markerSize(magnitude);  
    //   // Add the popup to the map
      // }.bindPopup(`</h1> <hr> <h3>Magnitude: ${properties[i].mag.toLocaleString()}</h3>`).addTo(myMap), magnitudeMarkers.push(radius)
    };
  // );
